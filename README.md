...
The mixpanel js is injected into the app's index.html. Pageview tracking is by default automatic, no mixins required. The mixpanel service is injected into your apps controllers, routes and components and is available as `this.mixpanel`.
...
// environment.js
    ...
    ENV.mixpanel: {
      enabled: false,
      automatic_pageview_tracking: true,
...
* `automatic_pageview_tracking` (Default: `true`): Automatically track all route transitions
